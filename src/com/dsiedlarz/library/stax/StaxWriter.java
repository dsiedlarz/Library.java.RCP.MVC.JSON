...
public class StaxWriter {
	...
	public static void saveLibrary(String configFile, Collection<Book> books) {
		synchronized (References.getLibrary()) {
			...
			try {
				eventWriter = outputFactory.createXMLEventWriter(new FileOutputStream(configFile),"UTF-8");
				...
				eventWriter.add(eventFactory.createStartElement("", "", "library"));
				eventWriter.add(end);
